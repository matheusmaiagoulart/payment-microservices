...
O **MS-Wallet** é o microserviço central de um sistema de pagamentos distribuído, responsável pelo ciclo de vida completo das carteiras digitais. Ele atua como o **núcleo financeiro** do ecossistema, garantindo consistência transacional, auditoria completa e alta disponibilidade.
