...
@ControllerAdvice
public class TransactionExceptionHandler extends TransactionAlreadySentException {

    @ExceptionHandler(TransactionAlreadySentException.class)
    private ResponseEntity<HandlerMessage> TransactionAlreadySentException(TransactionAlreadySentException transactionException){
    ...
    private ResponseEntity<HandlerMessage> FailedToSentException(FailedToSentException failedToSentException){
    ...
    @ExceptionHandler(CreatePaymentProcessException.class)
    public ResponseEntity<HandlerMessage> CreatePaymentProcessException(CreatePaymentProcessException createPaymentProcessException) {
        HandlerMessage handlerMessage = new HandlerMessage(HttpStatus.BAD_REQUEST, createPaymentProcessException.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(handlerMessage);
    }
}
