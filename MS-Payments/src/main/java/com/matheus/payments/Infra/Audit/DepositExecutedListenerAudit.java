...
/**
 * Audit class is responsible for create the logs related to DepositExecutedListener.
 * <p>
...
@Slf4j
@Component
public class DepositExecutedListenerAudit {

    public static final String CLASS_NAME = "DepositExecutedListener";
    public static final String EVENT_NAME = "DepositExecuted";
