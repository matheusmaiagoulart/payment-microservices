package com.matheus.payments.Infra.Kafka.Configs;
...
public class Producer {
    ...
    public NewTopic DepositCreated() {
        return TopicBuilder
                .name(KafkaTopics.DEPOSIT_TOPIC)
    ...
    public NewTopic DepositExecuted() {
        return TopicBuilder
                .name(KafkaTopics.DEPOSIT_EXECUTED_TOPIC)
                .partitions(1) //numero de consumidores que podem ler o topico em paralelo
                .replicas(1)
                .config("retention.ms", "604800000") //7 dias em milisegundos
                .build();
    ...
    public NewTopic DepositFailed() {
        return TopicBuilder
                .name(KafkaTopics.DEPOSIT_FAILED_TOPIC)
                .partitions(1) //numero de consumidores que podem ler o topico em paralelo
                .replicas(1)
                .config("retention.ms", "604800000") //7 dias em milisegundos
                .build();
